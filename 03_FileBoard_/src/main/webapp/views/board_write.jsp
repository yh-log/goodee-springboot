	...
	<div class="contents full">
		...
		<form action="board_write.do" method="post">
			...
			<div class="list">
				...
				<p>
					<textarea class="full" name="content" rows="20" cols="79" placeholder="내용을 입력하세요.">Lorem ipsum is a placeholder text commonly used to demonstrate the visual form of a document or a typeface without relying on meaningful content.</textarea>
				</p>
			</div>
			<div class="list">
